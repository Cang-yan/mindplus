      ...
      <div class="login-grid">
        ...
        <div class="form-section">
          ...
          <div class="form-footer">
            ...
            <span class="footer-brand">LINGINE</span>
          </div>
        </div>
      </div>
    </div>
...
const GITHUB_CLIENT_ID = getRuntimeConfig('VITE_GITHUB_CLIENT_ID')
const GITHUB_REDIRECT_URI = getRuntimeConfig('VITE_GITHUB_REDIRECT_URI') || `${window.location.origin}${import.meta.env.BASE_URL}login`
